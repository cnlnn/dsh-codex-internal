...
.dca-directory{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px}
...
@media(max-width:640px){.dca-directory{grid-template-columns:minmax(0,1fr)}.dca-model-main{grid-template-columns:minmax(0,1fr) 34px}.dca-model-main .dca-input:nth-child(2){grid-column:1/-1;grid-row:2}.dca-remove{grid-column:2;grid-row:1}.dca-model-options{grid-template-columns:minmax(0,1fr)}}
`;
			...
			return h("li", { className: `dca-card ${open ? "dca-card-open" : ""}` },
				...
				open ? h("div", { className: "dca-body" },
					...
					h("div", { className: "dca-field" },
						h("label", { className: "dca-label", htmlFor: "dca-working-directory" }, "工作目录"),
						h("div", { className: "dca-directory" },
							h("input", {
								id: "dca-working-directory", className: "dca-input", type: "text",
						...
						h("p", { className: "dca-hint" }, "Codex 读取项目文件时使用的默认目录。"),
					),
					h("div", { className: "dca-field" },
